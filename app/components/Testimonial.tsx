...
const TestimonialText = (props: Props) => {
  ...
  return <p className="text-center text-gray-600 dark:text-gray-400 text-sm">{children}</p>;
};
    ...
    <div className="bg-gray-100 dark:bg-gray-700 p-4">
      <div className="container mx-auto py-16 md:py-24">
        <div className="flex flex-col items-center gap-6 mb-10">
          <h2 className="text-3xl font-bold text-center">他/她们说</h2>
          <p className="text-center text-gray-600 dark:text-gray-400 text-lg">让世界听见你的声音</p>
        </div>
