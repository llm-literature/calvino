        ...
        <div className="mx-auto max-w-2xl space-y-6 text-center">
          ...
          <div className="rounded-lg border border-amber-900/30 bg-amber-950/10 p-6">
            <p className="mb-4 text-sm text-amber-200/80">
              But in order to be more easily remembered, Zora has languished, disintegrated, and
            ...
            >
              {isWithering ? (
                <>
                  <Hexagon className="h-4 w-4" /> Restore Memory
                </>
              ) : (
                <>
                  <ShieldAlert className="h-4 w-4" /> Force Motionlessness
                </>
              )}
            </button>
          </div>
