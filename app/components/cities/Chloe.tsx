            ...
            {people.map((p) => (
                ...
                >
                    <div className="relative">
                        <User 
                            className="w-24 h-24 text-rose-900/20 transition-colors duration-500 group-hover:text-rose-600" 
                            strokeWidth={1}
                        />
                        
                        {/* Thought Bubble */}
                        <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-4 w-48 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none">
                            <div className="bg-white p-4 rounded-xl shadow-xl text-xs text-center italic text-rose-800 relative">
                                &quot;{p.thought}&quot;
